...
# Python:   3.11.7
#
# Author:   Catie M. Condit, Daniel A. Christie
#
        ...
        while stop: #while stop ==  True
            if name == "":
                ...
                if name != "":
                    ...
                    stop = False
    return name #returning user's name to start()
...
def score(nice,mean,name):
    ...
    if mean > 2: # if condition is valid, call lose function passing in the variables so it can use them
        lose(nice,mean,name)
    else: #else, call nice_mean function passing in the varibales so it can use them
        nice_mean(nice,mean,name)


def win(nice,mean,name):
    #plays win sound
    winsound.PlaySound('win.wav', 0)
